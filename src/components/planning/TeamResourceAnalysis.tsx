      ...
      <Card>
        ...
        <CardContent>
          <p className="text-gray-600 mb-6">
            Analysis of team availability, skills, and cost for selected
            projects
          </p>
                  ...
                  <CardContent className="space-y-4">
                    ...
                    <div>
                      <div className="flex items-center justify-between mb-2">
                        ...
                        <span
                          className={`text-sm ${getAvailabilityColor(team.availabilityMatch)}`}
                        >
                          {Math.round(team.availabilityMatch)}%
                        </span>
                      </div>
                      <Progress
                        value={team.availabilityMatch}
                        className="h-2"
                      />
                    </div>
