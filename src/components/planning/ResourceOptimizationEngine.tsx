...
import { Team, Person, Project, Epic, Allocation } from '@/types';
...
const ResourceOptimizationEngine = () => {
  const { teams, people, projects, divisions, roles, allocations, cycles } =
    useApp();
  const [optimizationMode, setOptimizationMode] = useState<
    'efficiency' | 'capacity' | 'skills'
  >('efficiency');
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600">
            AI-powered resource allocation and efficiency optimization
          </p>
        </div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold text-blue-600">
              {(
                optimizationData.reduce(
                  (sum, t) => sum + t.currentUtilization,
                  0
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold text-orange-600">
              {
                optimizationData.filter(t => Math.abs(t.utilizationGap) > 10)
                  .length
              }
            </div>
                  ...
                  <div key={team.teamId} className="border rounded-lg p-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                      <div>
                        ...
                        <Progress
                          value={team.currentUtilization}
                          className="h-2"
                        />
                        <span className="text-sm font-medium">
                          {team.currentUtilization.toFixed(1)}%
                        </span>
                      </div>
                      ...
                      <div className="space-y-2">
                        <div className="flex justify-between">
                          ...
                          <span className="font-medium text-green-600">
                            +
                            {
                              optimizationResults.projectedGains
                        ...
                        <div className="flex justify-between">
                          ...
                          <span className="font-medium text-purple-600">
                            $
                            {(
                              optimizationResults.projectedGains.costSavings /
                              1000
                            ).toFixed(0)}
                            K
                          </span>
                        ...
                        <div className="flex justify-between">
                          ...
                          <span className="font-medium">
                            {optimizationResults.projectedGains.timeToImplement}
                          </span>
                        </div>
                      </div>
                    </div>
            ...
            <Card>
              <CardContent className="text-center py-12">
                ...
                <p className="text-gray-600 mb-4">
                  Click "Run Optimization" to analyze your teams and generate
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-center py-12">
                ...
                <p className="text-gray-600 mb-4">
                  Model different resource allocation scenarios and their impact
                  on team performance.
                </p>
