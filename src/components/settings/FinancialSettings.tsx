...
import { DollarSign, Plus, Trash2, AlertTriangle, CheckCircle } from 'lucide-react';
...
const FinancialSettings = () => {
  ...
  const validateRole = (role: Role) => {
    const hasContractorRates = (role.defaultHourlyRate && role.defaultHourlyRate > 0) || 
                              (role.defaultDailyRate && role.defaultDailyRate > 0);
    const hasPermanentRate = role.defaultAnnualSalary && role.defaultAnnualSalary > 0;
  ...
  const handleSave = () => {
    ...
    toast({
      ...
      description: "Your financial settings and role rates have been updated successfully.",
    });
  };
        ...
        <CardContent className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <Input
                ...
                onChange={(e) => setFySettings(prev => ({ ...prev, workingDaysPerWeek: Number(e.target.value) }))}
              />
            </div>
            <div>
              ...
              <Input
                ...
                onChange={(e) => setFySettings(prev => ({ ...prev, workingHoursPerDay: Number(e.target.value) }))}
              />
            </div>
          </div>
          ...
          <div>
            ...
            <Input
              ...
              onChange={(e) => setFySettings(prev => ({ ...prev, currencySymbol: e.target.value }))}
            />
          </div>
        </CardContent>
      </Card>
      ...
      <Card>
        <CardHeader>
          ...
          <p className="text-sm text-gray-600">
            Configure default rates for roles. These are used when individual team members don't have specific rates assigned.
          </p>
        </CardHeader>
        <CardContent>
                    ...
                    <div key={role.id} className="border rounded-lg p-4">
                      <div className="flex items-center justify-between mb-2">
                        <div className="flex items-center space-x-2">
                          <h3 className="font-medium">{role.name || 'Unnamed Role'}</h3>
                      ...
                      <div className="grid grid-cols-3 gap-4 text-sm">
                        <div>
                          <Label className="text-xs text-gray-500">Permanent Employee Salary</Label>
                        ...
                        <div>
                          <Label className="text-xs text-gray-500">Contractor Hourly Rate</Label>
                          <div className="font-medium">
                        ...
                        <div>
                          <Label className="text-xs text-gray-500">Contractor Daily Rate</Label>
                          <div className="font-medium">
                ...
                {localRoles.map((role) => (
                  <div key={role.id} className="border rounded-lg p-4 space-y-4">
                    ...
                    <div className="space-y-3">
                      <h4 className="font-medium text-sm">Permanent Employee Default Rates</h4>
                      <div>
                        <Label htmlFor={`annual-salary-${role.id}`}>Annual Salary</Label>
                        <div className="relative">
                          ...
                          <Input
                            ...
                            onChange={(e) => updateRole(role.id, 'defaultAnnualSalary', Number(e.target.value) || 0)}
                            className="pl-7"
                          />
                        </div>
                      </div>
                    ...
                    <div className="space-y-3">
                      <h4 className="font-medium text-sm">Contractor Default Rates</h4>
                      <div className="grid grid-cols-2 gap-4">
                        <div>
                          <Label htmlFor={`hourly-rate-${role.id}`}>Hourly Rate</Label>
                          <div className="relative">
                            <span className="absolute left-3 top-2 text-gray-500">$</span>
                            <Input
                              ...
                              onChange={(e) => updateRole(role.id, 'defaultHourlyRate', Number(e.target.value) || 0)}
                              className="pl-7"
                            />
                          </div>
                        </div>
                        <div>
                          <Label htmlFor={`daily-rate-${role.id}`}>Daily Rate</Label>
                          <div className="relative">
                            <span className="absolute left-3 top-2 text-gray-500">$</span>
                            <Input
                              ...
                              onChange={(e) => updateRole(role.id, 'defaultDailyRate', Number(e.target.value) || 0)}
                              className="pl-7"
                            />
                          </div>
                        </div>
                    ...
                    {role.defaultRate && role.defaultRate > 0 && (
                      <div className="bg-yellow-50 border border-yellow-200 rounded p-3">
                        <div className="flex items-center space-x-2">
                          ...
                          <span className="text-sm font-medium text-yellow-800">Legacy Rate Active</span>
                        </div>
                        <p className="text-sm text-yellow-700 mt-1">
                          This role has a legacy rate of ${role.defaultRate}/hour that will be used as fallback.
                        </p>
                      </div>
                    )}
