    ...
    return notifications.filter(notification => {
      if (searchTerm) {
        ...
        const matchesSearch =
          ...
          notification.metadata.tags.some(tag =>
      ...
      <Card>
            ...
            <div className="flex items-center gap-2">
              ...
              {exportable && (
                <DropdownMenu>
                  ...
                  <DropdownMenuContent>
                    <DropdownMenuItem
                      onClick={() => onExport?.('csv', notifications)}
                    >
                      Export as CSV
                    </DropdownMenuItem>
                  </DropdownMenuContent>
        ...
        <CardContent>
          ...
          <div
            className={cn(
              'space-y-4',
              virtualized && 'virtualized-notifications'
            )}
            data-testid={
              virtualized ? 'virtualized-notifications' : 'notifications-list'
            }
          >
            {groupBy !== 'none'
                        ...
                        <div className="space-y-2 ml-6">
                          {groupNotifications.map(notification => (
                            <NotificationCard
                              ...
                              expanded={expandedNotifications.has(
                                notification.id
                              )}
          ...
          <CardContent className="space-y-4">
            <div className="flex items-center justify-between">
              ...
              <Switch
                ...
                onCheckedChange={checked =>
                  handleSettingsToggle('globalEnabled', checked)
                }
            ...
            <div className="flex items-center justify-between">
              ...
              <Switch
                ...
                onCheckedChange={checked =>
                  handleSettingsToggle('soundEnabled', checked)
                }
            ...
            <div className="flex items-center justify-between">
              ...
              <Switch
                ...
                onCheckedChange={checked =>
                  handleSettingsToggle('doNotDisturbEnabled', checked)
                }
    ...
    >
      ...
      {expanded && (
        <CardContent className="pt-0">
          {lazyLoadDetails ? (
            <div
              data-testid="notification-details-loading"
