...
export function PredictiveInsightsPanel({
  ...
  const [favoriteInsights, setFavoriteInsights] = useState<Set<string>>(
    new Set()
  );
      ...
      <Card className="w-full">
            ...
            <div className="flex items-center gap-4 mt-4">
              ...
              {showFilters && (
                <div className="flex items-center gap-2">
                  ...
                  <Select
                    onValueChange={value => setSelectedPriorities([value])}
                  >
                    <SelectTrigger
                      className="w-40"
        ...
        <CardContent>
          ...
          {showHistoryPanel && (
            <div className="mb-6" data-testid="insight-history">
              ...
              <div className="space-y-2">
                <p className="text-sm text-muted-foreground">
                  Recent insight changes and updates
                </p>
              </div>
            </div>
          )}
          ...
          <div
            ...
            data-testid={
              virtualized ? 'virtualized-insights' : 'insights-container'
            }
          >
            {customTemplate
              ? sortedInsights.map(insight => (
                  <div key={insight.id}>{customTemplate(insight)}</div>
                ))
              : sortedInsights.map(insight => {
                  ...
                  return (
                    <Card
                      ...
                      className={cn(
                        ...
                        comparisonMode &&
                          selectedForComparison.has(insight.id) &&
                          ...
                          <div className="flex-1">
                            ...
                            <div className="flex items-center gap-4 text-sm text-muted-foreground">
                              <div className="flex items-center gap-1">
                                <TrendIcon
                                  className="h-3 w-3"
                                  data-testid={`trend-${insight.trend}`}
                                />
                              ...
                              <div
                                ...
                                data-testid={`confidence-${insight.confidence}`}
                              >
                                {insight.likelihood}%
                              </div>
                          ...
                          >
                            {lazyLoadDetails ? (
                              <div
                                ...
                                data-testid="insight-details-loading"
                              >
                                          ...
                                          (metric, index) => (
                                            ...
                                            >
                                              ...
                                              {showMetricCharts && (
                                                <div
                                                  className="mt-2"
                                                  data-testid={`metric-chart-${metric.name.toLowerCase().replace(/\s+/g, '-')}`}
                                                >
                                                  <div
                                                    data-testid="metric-chart"
                                                    className="h-16 bg-gray-100 rounded flex items-center justify-center text-xs text-muted-foreground"
                                                  >
