...
export function AdaptiveResourceOptimizer({
  ...
  const [selectedStrategy, setSelectedStrategy] =
    useState<OptimizationStrategy>('balanced');
  ...
  // Filter resources - moved before early returns
          ...
          <CardContent className="flex items-center justify-center p-8">
            <div className="text-center" data-testid="empty-resources-state">
              ...
              <p className="text-sm text-muted-foreground">
                Add resources to start optimization
              </p>
            </div>
          </CardContent>
        </Card>
    ...
    >
      ...
      <Card data-testid="resource-metrics">
        ...
        <CardContent>
          <div className="grid grid-cols-4 gap-4 text-center">
            ...
            <div>
              <div className="text-2xl font-bold">
                Efficiency: {Math.round(metrics.efficiencyScore * 100)}%
              </div>
            ...
            <div className="flex items-center gap-4">
              ...
              {showStrategies && (
                <Select
                  ...
                  onValueChange={(value: OptimizationStrategy) =>
            ...
            <div className="flex items-center gap-2">
              ...
              {exportable && (
                <DropdownMenu>
                  ...
                  <DropdownMenuContent>
                    <DropdownMenuItem
                      onClick={() => onExport?.('pdf', { resources, metrics })}
                    >
                      Optimization Report
                    </DropdownMenuItem>
                  </DropdownMenuContent>
        ...
        <CardContent>
          ...
          {showRecommendations && (
            <div className="mb-6" data-testid="optimization-recommendations">
              ...
              <p className="text-sm text-muted-foreground">
                {metrics.recommendations} recommendations available
              </p>
            </div>
          )}
                        ...
                        <div className="flex items-center justify-between">
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              ...
                              <Badge data-testid={`status-${resource.status}`}>
                                {resource.status}
                              </Badge>
                            </div>
                          </div>
                        ...
                        {isExpanded && (
                          ...
                          >
                            <div className="grid grid-cols-2 gap-4 text-sm">
                              ...
                              <div>
                                Efficiency:{' '}
                                {Math.round(resource.efficiency * 100)}%
                              </div>
      ...
      {showAnalytics && (
        <Card data-testid="efficiency-analytics">
          ...
          <CardContent>
            <div>
              Overall efficiency: {Math.round(metrics.efficiencyScore * 100)}%
            </div>
          </CardContent>
        </Card>
      )}
