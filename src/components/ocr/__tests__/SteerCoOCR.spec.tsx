...
// Mock the pptx2json library
vi.mock('pptx2json', () => ({
  default: class {
    async parse() {
      return Promise.resolve({
        slides: [{ content: 'Project Phoenix' }, { content: 'Project Titan' }],
      });
    }
  },
}));
...
describe('SteerCoOCR Component with mocked pptx2json', () => {
  it('should process a real PPTX file with a mocked parser', async () => {
