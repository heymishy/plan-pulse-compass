...
const AnnualFinancialReport: React.FC<AnnualFinancialReportProps> = ({
  ...
  const totalAnnualCostForAllProjects = reportData.reduce(
    (sum, data) => sum + data.totalAnnualCost,
    0
  );
  const averageProjectCost =
    reportData.length > 0
      ? totalAnnualCostForAllProjects / reportData.length
      : 0;
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">
              {formatCurrency(totalAnnualCostForAllProjects)}
            </div>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">
              Average annual cost per project
            </p>
          </CardContent>
        </Card>
      </div>
