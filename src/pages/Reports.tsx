...
const Reports = () => {
  ...
  const monthlyTrendData = useMemo(() => {
    ...
    return months.map(month => {
      ...
      const estimatedCost = financialMetrics.totalMonthlyCost * (0.8 + Math.random() * 0.4);
    ...
    return (
      <div className="p-6">
        <div className="text-center py-12">
          ...
          <p className="text-gray-600">Please complete the setup to view financial reports.</p>
        </div>
      </div>
    );
  }
    ...
    <div className="p-6 space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600">Track project costs, team utilization, and budget performance</p>
        </div>
              ...
              <div key={team.teamName} className="flex items-center justify-between p-4 border rounded-lg">
                ...
                <div className="flex items-center space-x-4">
                  <div className="text-right">
                    <div className="font-medium">${team.monthlyCost.toLocaleString()}/month</div>
                  ...
                  <div className="w-20">
                    <div className="bg-gray-200 rounded-full h-2">
                      <div
                        ...
                        style={{ width: `${Math.min(team.utilization * 100, 100)}%` }}
                      />
                    </div>
                  </div>
                </div>
