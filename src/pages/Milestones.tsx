...
import { Plus, Grid, Table, Calendar, AlertTriangle, CheckCircle, Clock } from 'lucide-react';
...
const Milestones = () => {
  ...
  const handleEditMilestone = (milestone: Milestone) => {
    const project = projects.find(p => p.milestones.some(m => m.id === milestone.id));
  ...
  const getUpcomingMilestones = () => {
    ...
    return allMilestones.filter(milestone => {
      ...
      return dueDate >= now && dueDate <= nextWeek && milestone.status !== 'completed';
    }).length;
  };
    ...
    <div className="p-6 space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600">Track project milestones and delivery dates</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-6 gap-4">
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{statusCounts.notStarted}</div>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <Badge variant="outline" className="mt-1">Next 7 days</Badge>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <Badge variant="destructive" className="mt-1">Past Due</Badge>
          </CardContent>
        </Card>
      </div>
